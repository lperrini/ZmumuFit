...
cats["mt_13TeV"] = {
        ...
        {0,"mt_0jet"}, {1,"mt_1jet_zpt_loose"},
	{2,"mt_1jet_zpt_medium"},{3,"mt_1jet_zpt_tight"},
	{4,"mt_2jet_cp"}, {5,"mt_vbf"},
	{6,"mt_1bjet"}, {7,"mt_2bjet"}, {8,"mt_MSSM_btag"}};
...
for (string era : {"13TeV"}) {
	...
	for (string chn : chns) {
		...
		TFile output((folder + "/common/ztt_" + chn + ".input_E.root").c_str(),
				"RECREATE");
